...
class OcclusionScore:
    def __init__(self, selector: BaseSelectorWrapper, removed_features: int, report: ClassificationScoreReport, loss: float, loss_by_label: dict[int, float], inverse_report: ClassificationScoreReport) -> None:
...
class OcclusionScorePerLabel(OcclusionScore):
    def __init__(self, selector: BaseSelectorWrapper, removed_features: int, label: int, report: ClassificationScoreReport, loss: float, loss_by_label: dict[int, float], inverse_report: ClassificationScoreReport) -> None:
