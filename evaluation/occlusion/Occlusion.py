...
from config.general_config import OCCLUSION_INITIAL_END, OCCLUSION_STEP, SHOULD_CALCULATE_METRICS_BY_LABEL, OCCLUSION_BY_LOSS, OCCLUSION_LIMIT, OCCLUSION_INITIAL_STEP, OUTPUT_PATH, OCCLUSION_OUTPUT_SUB_PATH, SHOULD_SAVE_OCCLUSION_VIDEO, OCCLUSION_STEP_ON_CHART
...
from util.feature_selection_util import remove_n_features_from_inversed_rank, remove_n_features_from_rank
...
from util.plot_util import save_plots_as_video
from util.performance_util import ExecutionTimeCounter
from util.numpy_util import convert_nparray_to_tensor
...
def calculate_and_persist_occlusion(selector: BaseSelectorWrapper, dataset: Dataset):
    ...
    if SHOULD_CALCULATE_METRICS_BY_LABEL and SelectionSpecificity.PER_LABEL in selector.get_selection_specificities():
